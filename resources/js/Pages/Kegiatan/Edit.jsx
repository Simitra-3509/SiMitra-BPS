...
function Edit({ auth, kegiatan }) {
    const { data, setData, put, processing, errors } = useForm({
        nomor_kro: kegiatan.nomor_kro || '',
        nama_kegiatan: kegiatan.nama_kegiatan || '',
        jenis_sbml: kegiatan.jenis_sbml || '',
        ...
        status_aktif: kegiatan.status_aktif !== undefined ? kegiatan.status_aktif : 1,
    });
        ...
        <>
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800 tracking-tight">Edit Kegiatan</h1>
                        <p className="text-sm text-gray-500">Perbarui data kegiatan survei/sensus</p>
                    </div>
                </div>
