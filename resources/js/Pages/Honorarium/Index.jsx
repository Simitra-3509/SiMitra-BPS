        ...
        <>
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Daftar Honorarium</h1>
                        <p className="text-sm text-gray-500 mt-1">Riwayat pembayaran honor mitra</p>
                    </div>
                    ...
                    <form onSubmit={handleFilter} className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                        <div className="md:col-span-3">
                            ...
                            <select
                                ...
                                className="w-full border-gray-300 focus:border-[#F26522] focus:ring-[#F26522] rounded-md shadow-sm text-sm py-2 px-3"
                            >
                        ...
                        <div className="md:col-span-5 flex gap-2">
                            <div className="flex-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-9 border-gray-300 focus:border-[#F26522] focus:ring-[#F26522] rounded-md shadow-sm text-sm py-2"
                                    />
                                </div>
                            </div>
                            <div className="flex gap-2 items-end">
                                ...
                                <button
                                    type="button"
                                    onClick={handleReset}
                                    className="px-4 py-2 bg-white border border-gray-300 text-gray-700 text-sm font-semibold rounded-md hover:bg-gray-50 flex items-center gap-1 transition-colors"
                                >
                                    <X size={14} /> Reset
                                </button>
                            </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-100 text-sm text-gray-700">
                            {honorarium?.data && honorarium.data.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan="7" className="p-12 text-center bg-gray-50/50">
